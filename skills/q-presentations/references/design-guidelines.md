...
For every style, the Background spec must be ONE line describing the surface. Use "flat" and "edge to edge" for uniformity. Never add:
- Uniformity paragraphs
- Lists of what NOT to do (no vignettes, no gradients, etc.)
- Per-slide background reminders
