...
Structure for user preferences in `.q-skills/q-presentations/EXTEND.md`.
...
## q-presentations Settings
logo_position: top-right      # top-right | bottom-right | top-left | bottom-left | none
video_overlay: right          # right | left | bottom | none
...
Then use with: `/q-presentations content.md --style style-name`
